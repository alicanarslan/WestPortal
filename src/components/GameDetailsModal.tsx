...
import GameDetailsAbout from "./game-details/GameDetailsAbout";
import GameDetailsSpecs from "./game-details/GameDetailsSpecs";
import GameDetailsReviews from "./game-details/GameDetailsReviews";
