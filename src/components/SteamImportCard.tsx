...
import { 
  ...
  RefreshCw, Check, Link2, Eye, HelpCircle, FileText
} from "lucide-react";
                      ...
                      <tr key={g.id} className="hover:bg-slate-950/40 transition-colors">
                        ...
                        <td className="py-3 px-2 text-right">
                          <button
                            ...
                            className="p-1 px-2.5 rounded bg-red-950/20 hover:bg-red-950/40 border border-red-500/20 text-red-400 hover:text-red-300 transition-all font-bold text-[10px] uppercase"
                          >
                            Sil
                          </button>
                        </td>
